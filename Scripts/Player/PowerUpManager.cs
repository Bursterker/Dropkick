...
public class PowerUpManager : MonoBehaviour {
    ...
    {
        //m_PowerUpAuraParticle = particleObject;
    }
    ...
    public bool AddPowerUp(PowerUp power)
    {
        ...
        //Set the particle
        //m_PowerUpAuraParticle.SetActive(true);
       // StartCoroutine(DisableParticle(m_CurrentTimer, m_PowerUpAuraParticle));
        ...
        return true;
        //returns true if power is added succesful
    }
    ...
    //IEnumerator DisableParticlePickUp()
    //{
    //    yield return new WaitForSeconds(m_ParticlePickUp.GetComponentInChildren<ParticleSystem>().main.duration);
    //    m_ParticlePickUp.SetActive(false);
    //    StopCoroutine(DisableParticlePickUp());
    //}
